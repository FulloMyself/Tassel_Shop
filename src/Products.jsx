...
description: "Our skin brightening gel contains arbutin and vitamin C. Alpha arbutin targets and prevents dark spots, while vitamin C stimulates collagen production, fights free radicals, and enhances overall skin brightness. Together, they create a harmonious blend that not only tackles pigmentation issues but also promotes a healthier and more youthful complexion.",
  ...
  {
    id: 18,
    name: "Esse Package - Trial/ Starter Set",
    price: 1540,
    salePrice: 0,
    category: "wellness",
    image: `${import.meta.env.BASE_URL}images/products/Esse_Package.jpg`,
    description: "Starter set for sensitive skin. A selection of 4 generously sized (+-30 days) sensitive skin products to begin your rewilding journey. The set is ideal to try the range, for travel, or as a gift.",
  },
  {
    id: 19,
    ...
    description: "Ximenia Oil shields sensitive skin, offering it all-round protection from environmental stressors. Independent testing shows that it increases skin hydration, firmness, and elasticity, while reducing wrinkle depth. 15ml. FOR ALL SENSITIVE SKIN",
  },
  {
    id: 20,
  ...
  {
    id: 35,
    name: "Tassel Scented Candles - 300ml",
    price: 380,
    salePrice: 0,
    category: "wellness",
    image: `${import.meta.env.BASE_URL}images/products/Tassel_Candle.jpg`,
    description: "",
  },
  {
    id: 36,
    name: "Tassel Scented Candles - 350ml",
    price: 550,
    salePrice: 0,
    category: "wellness",
    image: `${import.meta.env.BASE_URL}images/products/Tassel_Candle.jpg`,
  ...
  {
    id: 37,
    name: "Tassel Coconut Cocktail Bath Salts",
    price: 200,
    salePrice: 0,
    category: "skincare",
  ...
  {
    id: 38,
    name: "Tassel SPF50 Sun Protection",
    price: 200,
    salePrice: 150,
    category: "skincare",
    image: `${import.meta.env.BASE_URL}images/products/Tassel_SPF50.jpg`,
    description: "",
  },
];
